...
export default function LoginForm({ role }) {
  ...
  return (
    <>
      <div className='flex h-1/2 w-full flex-col items-center justify-center md:w-96'>
        <p className='pb-4 text-xl font-semibold capitalize text-primary'>
        ...
        <Input
          ...
          outline={false}
          className='mb-4 flex w-full items-center space-x-[10px] rounded-[16px] border border-[#E3E3E3] p-4'
        />
        <Input
        ...
        />
        <p className='mb-4 mt-1 flex w-full cursor-pointer justify-end text-right text-xs font-semibold text-primary'>
          Lupa Password
        </p>
        ...
        <p className='w-full pb-12 text-center text-sm md:w-96'>
          Belum punya akun?
          <span
